...
<html>
  <body>
    ...
    print("<TABLE width=\"100%\" bgcolor=\"#CCCCFF\"><TR><TD><FONT size=\"4\" color=\"#000000\"><center><B><a href=\"/rubbos/ViewComment.php?comment_table=$comment_table&storyId=".$row["story_id"]."&commentId=".$row["id"]."\">".$row["subject"]."</a></B>&nbsp</FONT> (Score:".$row["rating"].")</center></TABLE>\n");
    print("<TABLE><TR><TD><B>Posted by ".$username." on ".date('m/d/Y', $row["date"])."</B><p>\n");
    print("<TR><TD>".$row["comment"]."</TABLE><p><hr><p>\n".
          "<form action=\"/rubbos/StoreModeratorLog.php\" method=POST>\n".
